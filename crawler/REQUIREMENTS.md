...
1. print nothing to stdout, other than logging its progress; see an example format in the [lecture unit](https://www.cs.dartmouth.edu/~cs50/Lectures/units/crawler.html).
